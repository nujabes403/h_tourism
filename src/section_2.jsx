      ...
      <div className="section_2_jumbotron jumbotron">
        ...
        <div className="row">
          <div className="col-md-4">
            <img onMouseEnter={this.handleImg} id="first_img" className="section_2_imgs" src="assets/imgs/sales_up.png"/>
            <h3 className="section_2_jumbotron_h3">성장산업</h3>
            </div>
          <div className="col-md-4">
            <img onMouseEnter={this.handleImg} id="second_img" className="section_2_imgs" src="assets/imgs/pie_chart.png"/>
            <h3 className="section_2_jumbotron_h3">세계경제의 관광분야 기여도</h3>
            </div>
          <div className="col-md-4">
            <img onMouseEnter={this.handleImg} id="third_img" className="section_2_imgs" src="assets/imgs/employee.png"/>
